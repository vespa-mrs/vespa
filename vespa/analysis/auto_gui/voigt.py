# -*- coding: UTF-8 -*-
#
# generated by wxGlade 1.0.5 on Wed Aug 20 17:35:30 2025
#
...
class PanelVoigtUI(wx.Panel):
    def __init__(self, *args, **kwds):
        ...
        self.CheckOptimizeWeightsOtherFlag = wx.CheckBox(self.PanelOptimization, wx.ID_ANY, " Apply Min in Other Region  - Start:")
        grid_sizer_7.Add(self.CheckOptimizeWeightsOtherFlag, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT | wx.RIGHT, 4)

        self.FloatOptimizeWeightsOtherStart = FloatSpin(self.PanelOptimization, wx.ID_ANY, value=0.0, digits=3, min_val=0.0, max_val=100.0, increment=1.0, agwStyle=FS_LEFT, style=0)
        grid_sizer_7.Add(self.FloatOptimizeWeightsOtherStart, 0, wx.ALIGN_CENTER_VERTICAL | wx.RIGHT, 6)

        label_32 = wx.StaticText(self.PanelOptimization, wx.ID_ANY, "End:")
        grid_sizer_7.Add(label_32, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT | wx.LEFT | wx.RIGHT, 4)

        self.FloatOptimizeWeightsOtherEnd = FloatSpin(self.PanelOptimization, wx.ID_ANY, value=0.0, digits=3, min_val=0.0, max_val=100.0, increment=1.0, agwStyle=FS_LEFT, style=0)
        grid_sizer_7.Add(self.FloatOptimizeWeightsOtherEnd, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        ...
        self.Bind(wx.EVT_CHECKBOX, self.on_optimize_weights_other_flag, self.CheckOptimizeWeightsOtherFlag)
        self.Bind( EVT_FLOATSPIN, self.on_optimize_weights_other_start, self.FloatOptimizeWeightsOtherStart)
        self.Bind( EVT_FLOATSPIN, self.on_optimize_weights_other_end, self.FloatOptimizeWeightsOtherEnd)
    ...
    def on_optimize_weights_other_flag(self, event):  # wxGlade: PanelVoigtUI.<event_handler>
        print("Event handler 'on_optimize_weights_other_flag' not implemented!")
        event.Skip()

    def on_optimize_weights_other_start(self, event):  # wxGlade: PanelVoigtUI.<event_handler>
        print("Event handler 'on_optimize_weights_other_start' not implemented!")
        event.Skip()

    def on_optimize_weights_other_end(self, event):  # wxGlade: PanelVoigtUI.<event_handler>
        print("Event handler 'on_optimize_weights_other_end' not implemented!")
        event.Skip()
