# -*- coding: UTF-8 -*-
#
# generated by wxGlade 1.0.5 on Wed May 17 19:40:14 2023
#
...
class PanelVisualizeUI(wx.Panel):
    def __init__(self, *args, **kwds):
        ...
        sizer_10.Add(sizer_29, 1, wx.ALL | wx.EXPAND, 3)

        label_2 = wx.StaticText(self.PanelVisualize, wx.ID_ANY, "Max", style=wx.ALIGN_RIGHT)
        sizer_29.Add(label_2, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL, 4)
        ...
        sizer_29.Add(self.FloatXaxisMax, 1, wx.ALIGN_CENTER_VERTICAL, 0)

        label_3 = wx.StaticText(self.PanelVisualize, wx.ID_ANY, "Min", style=wx.ALIGN_RIGHT)
        sizer_29.Add(label_3, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL, 4)
        ...
        sizer_29.Add(self.FloatXaxisMin, 1, wx.ALIGN_CENTER_VERTICAL, 0)
        ...
        sizer_30.Add(label_4, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL, 4)
        ...
        sizer_30.Add(self.FloatCursorMax, 1, wx.ALIGN_CENTER_VERTICAL, 0)

        label_5 = wx.StaticText(self.PanelVisualize, wx.ID_ANY, "Min", style=wx.ALIGN_RIGHT)
        sizer_30.Add(label_5, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL, 4)
        ...
        sizer_30.Add(self.FloatCursorMin, 1, wx.ALIGN_CENTER_VERTICAL, 0)
        ...
        sizer_16.Add(self.label_14, 0, wx.ALIGN_CENTER_VERTICAL | wx.RIGHT, 40)

        self.CheckSumPlots = wx.CheckBox(self.PanelVisualize, wx.ID_ANY, "Sum Plots   ")
        sizer_16.Add(self.CheckSumPlots, 0, wx.ALL | wx.EXPAND, 4)
        ...
        sizer_23.Add(self.buttonResolution, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL, 3)

        sizer_22 = wx.BoxSizer(wx.HORIZONTAL)
        sizer_23.Add(sizer_22, 1, wx.ALL, 3)

        label_11 = wx.StaticText(self.PanelVisualize, wx.ID_ANY, "Line Width [Hz] : ", style=wx.ALIGN_RIGHT)
        sizer_22.Add(label_11, 0, wx.ALIGN_CENTER_VERTICAL | wx.RIGHT, 5)
        ...
        sizer_22.Add(self.FloatLinewidth, 0, wx.ALIGN_CENTER_VERTICAL, 0)
